...
export default function ApillonLogin({ onGoBack }: ApillonLoginProps) {
  ...
  return (
    <div className="w-full dark:bg-zinc-900/10 bg-zinc-300/10">
      <div className="dark:border-stone-800/40 border-stone-600/40 overflow-hidden relative bg-gradient-to-r from-green-300/20 via-cyan-200/20 to-indigo-600/20 dark:bg-gradient-to-r dark:from-stone-800/5 dark:via-stone-800/5 dark:to-stone-800/20 hover:border-primary/40 dark:hover:border-stone-800/90 border p-4 rounded-xl w-full min-h-[384px] sm:h-full flex flex-col flex-1 transition-colors duration-300 ease-in-out delay-50">      <GridPattern
              size={75}
              offsetX={0}
              offsetY={0}
              className="absolute -top-1/2 right-1 h-[200%] w-2/3 skew-y-12 dark:stroke-white/10 stroke-indigo-600/20  stroke-[2] [mask-image:linear-gradient(-85deg,black,transparent)]"
            >
