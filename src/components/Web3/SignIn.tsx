  ...
  const handleSignIn = async () => {
    try {
      ...
      const siwsMessage = new SiwsMessage({
        domain: SIWS_DOMAIN,
        uri: SIWS_DOMAIN,
        // use prefix of Agung Testnet change to Tanssi
  ...
  return (
    <div className="h-full flex flex-1 flex-col">
      ...
      <div className="flex justify-end items-center gap-4 z-10">
        <button
          onClick={onCancel}
          className="bg-transparent border  border-basement-purple hover:bg-basement-purple hover:animate-pulse text-white font-bold py-2 px-4 rounded uppercase font-clash text-sm"
        >
          Cancel
        </button>
        ...
        <button
          ...
          } text-white font-bold py-2 px-4 rounded uppercase font-clash text-sm`}
        >
