...
export function SectionWrapper({ children, className }: FeatureCardProps) {
  return <div className={clsx("relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", className)}>{children}</div>
}

export function SectionWrapperRounded({ children, className, ...props }: FeatureCardProps) {
  return (
...
export function SectionBadge({ children, className }: FeatureCardProps) {
  return <span className={clsx("text-sm tracking-tight text-accent-300 font-ribbon uppercase", className)}>{children}</span>
}

export function SectionDescription({ children, className }: FeatureCardProps) {
  return (
    <p
      className={clsx(
        "mx-auto mt-4 text-left leading-relaxed text-gray-800 dark:text-white/50 md:max-w-2xl md:text-center lg:mt-8",
        className,
      )}>
      {children}
    </p>
...
export function SectionHeading({ children, className }: FeatureCardProps) {
  return <div className={clsx("flex flex-col md:items-center", className)}>{children}</div>
}

export function SectionHeadingHighlighted({ children, className }: FeatureCardProps) {
  return (
    <div>
      <div
        className={clsx(
          "flex flex-col bg-[radial-gradient(35%_128px_at_50%_100%,theme(backgroundColor.white/5%),transparent)] pb-8 md:items-center lg:pb-16",
          className,
        )}>
        {children}
      </div>
...
export function SectionTitle({ children, className }: FeatureCardProps) {
  return (
    <h2
      className={clsx(
...
export function SectionTitleSmall({ children, className }: FeatureCardProps) {
  return (
    <h2
      className={clsx(
...
export function SectionTitleFade({ children, className }: FeatureCardProps) {
