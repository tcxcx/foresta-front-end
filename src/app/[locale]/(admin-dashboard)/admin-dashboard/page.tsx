            ...
            <TabsContent value="projects" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">63,231.89 Ha</div>
                    <p className="text-xs text-muted-foreground">
                      +20.1% from last month
                    </p>
                  </CardContent>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">+256,234</div>
                    <p className="text-xs text-muted-foreground">
                      +19% from last month
                    </p>
                  </CardContent>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">573.567,03</div>
                    <p className="text-xs text-muted-foreground">
                      +201 since last hour
                    </p>
                  </CardContent>
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                ...
                <Card className="col-span-3">
                  <CardHeader>
                    ...
                    <CardDescription>
                      You have received 265 project submissions this month.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
            ...
            <TabsContent value="kyc" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">453.89</div>
                    <p className="text-xs text-muted-foreground">
                      +20.1% from last month
                    </p>
                  </CardContent>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">+$123,234</div>
                    <p className="text-xs text-muted-foreground">
                      +19% from last month
                    </p>
                  </CardContent>
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                ...
                <Card className="col-span-3">
                  <CardHeader>
                    ...
                    <CardDescription>
                      There have been 26 KYC requests this month.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ApplicantsList />
